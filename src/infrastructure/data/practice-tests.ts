...
const koreanListening: LevelSeed[] = [
  { title: "자연스러운 한국어 대화", focus: "대화 · 표준어", prompt: "두 화자의 관계, 대화의 중심 주제와 반응 표현을 메모하세요.", model: "두 화자는 자연스러운 속도로 경험과 의견을 주고받으며 상대의 말에 짧게 반응한다.", weak: "한 사람이 준비한 글을 혼자 읽는다.", detail: "두 화자가 경험과 의견을 자연스럽게 주고받는 대화", distractors: ["뉴스를 한 사람이 낭독함", "노래 가사를 설명함", "시험 날짜만 안내함"], media: { provider: "youtube", videoId: "uNHfC7pbcbU", title: "Natural Korean Conversation", creator: "Talk To Me In Korean", kind: "story", variety: "서울 표준어 · 자연 대화", sourceUrl: "https://www.youtube.com/watch?v=uNHfC7pbcbU" } },
